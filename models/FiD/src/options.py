...
class Options():
    ...
    def add_reader_options(self):
        ...
        self.parser.add_argument('--gold_passages_train', type=str, default=None, help='path of gold passages of train data')
        ...
        self.parser.add_argument('--use_pi_f1', action='store_true', 
                        help='use PI F1 scores for evaluation instead of RG F1')
