...
def main(cfg: DictConfig):
    ...
    #print("cfg: ", cfg)
    #print("cfg.encoder: ", cfg.encoder)
    #print("cfg.encoder.encoder_model_type: ", cfg.encoder.encoder_model_type)
    #print("cfg.indexers", cfg.indexers)
    ...
    logger.info("Saving results in %s", cfg.out_file)
    if cfg.out_file:
